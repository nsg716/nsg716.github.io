...
## 🎓 Activities
<!-- - (주)그노티 현장실습(인턴십) - (2025.03.04~2025.08.29)(6개월) -->
...
1. 회사 및 실습 개요 
실습 기간: 2024.01 ~ 2024.06 (6개월)
 프로젝트 A: 인트라넷 시스템 리뉴얼

(1) 개요
사내 인트라넷 시스템의 리뉴얼 프로젝트 참여
React 기반 프론트엔드 개선, API 연동, 테스트 자동화 구축 등

(2) 담당 업무
React 컴포넌트 리팩토링 및 상태관리 개선
Spring Boot 기반 REST API 개발
GitLab CI/CD 설정 및 자동 배포 스크립트 작성
QA 테스트 케이스 자동화 (Selenium 기반)

(3) 기술 스택
React, Redux, Spring Boot, MySQL, GitLab CI/CD, Selenium

(4) 성과 및 기여
API 응답속도 40% 개선 (쿼리 최적화)
자동화 테스트 도입으로 QA 시간 20% 단축

3. 프로젝트 B: 사내 문서검색 챗봇 PoC 개발
(1) 개요
GPT 기반 검색형 챗봇 PoC 프로젝트 참여
사내 매뉴얼/정책 자료를 RAG 방식으로 연결하여 답변 제공

(2) 담당 업무
프론트엔드 대화형 UI 개발 (React + OpenAI API 연동)
Python 기반 LangChain + FAISS 벡터 검색 엔진 구축
사내 문서 전처리 및 PDF 임베딩 파이프라인 개발

(3) 기술 스택
React, Python, LangChain, FAISS, OpenAI API, Docker
